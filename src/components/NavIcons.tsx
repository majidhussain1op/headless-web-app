...
const isLoggedIn = false
  ...
  return (
    <div className="flex items-center gap-4 xl:gap-6 relative">
      ...
      />
      {
        isOpenProfile && <div className="absolute p-4 rounded-md top-12 left-0 text-sm shadow-[0_3px_10px_rgb(0,0,0,0.2)] z-20">
      ...
      />
      <div className="absolute -top-4 -right-4 w-6 h-6 bg-rose rounded-full text-white text-sm flex items-center justify-center">2</div>
      </div>
